...
$(function () {
    ...
    */
    $('.wc-menu').attr('data-toggle', 'tooltip').attr('data-placement', 'top').attr('data-html', 'true').attr('title', '<a href="#" onClick="javascript:guideMenuOrgMent(\'자주하는질문\')"><li class="guideMenu">자주하는 질문</li></a><br><a href="#" onClick="goShowUserGuideModal()"><li class="guideMenu">이용가이드</li></a><br><a href="https://www.hanjin.co.kr/Delivery_html/business/notice_list.jsp" target="_blank"><li class="guideMenu">공지사항</li></a>')
